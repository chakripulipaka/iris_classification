...
if st.sidebar.button("Classify"):
	if classifier == "Support Vector Machine":
		species_name = prediction(svc_model, s_len, s_wid, p_len, p_wid)
		score = svc_model.score(X_train, y_train)
	elif classifier == "Logistic Regression":
		species_name = prediction(log_reg, s_len, s_wid, p_len, p_wid)
		score = log_reg.score(X_train, y_train)
	else:
		species_name = prediction(rf_clf, s_len, s_wid, p_len, p_wid)
		score = rf_clf.score(X_train, y_train)
	st.write("Species predicted: " + species_name)
	st.write("Accuracy score of this model is: " + str(score))